    ...
    Flickable {
        ...
        Column {
            ...
            Item {
                ...
                Rectangle {
                    ...
                    MouseArea {
                        ...
                        onExited: parent.opacity = 0.9
                        onClicked: {
                            playlistFlickable.contentX = Math.min(playlistFlickable.contentWidth - playlistFlickable.width, playlistFlickable.contentX + 500);
                        }
                    }
                }
                                ...
                                Rectangle {
                                    ...
                                    Rectangle {
                                        ...
                                        gradient: Gradient {
                                            GradientStop {
                                                position: 0.0
                                                color: Qt.lighter(model.coverColor, 1.3)
                                            }
                                            GradientStop {
                                                position: 1.0
                                                color: Qt.darker(model.coverColor, 1.2)
                                            }
                                        }
            ...
            GridView {
                id: postGrid
                width: parent.width - 32
                height: Math.ceil(postGrid.count / 2) * 130
                cellWidth: (width - 16) / 2
                cellHeight: 130
                clip: true
                interactive: false  // 禁用 GridView 自己的滚动，使用外层 Flickable 滚动
                ...
                delegate: AudioBookCard {
                    width: postGrid.cellWidth - 8
                    height: postGrid.cellHeight - 8
                    coverType: model.coverType
                    titleText: model.title
                    descText: model.desc
                    scoreText: model.score
